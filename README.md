...
| Lab 2 | Simple Agents | `Lab-2-Simple-Agents.ipynb` |
| Lab 3 | Chat Agents and MAS | `Lab-3-Chat-Agents.ipynb` |
| Lab 4 | Search Algorithms | `Lab-4-Search-Algorithms.ipynb` |
| Lab 5 | Simple Expert Systems | `Lab-5-Expert-Systems.ipynb` |
| Lab 6 | Connectionist Models | `Lab-6-Connectionist-Models.ipynb` |
| Lab 7 | APIfying AI | `lab7-search-api.zip` |
| Lab 8 | LLM APIs | `Lab-8-LLM-APIs.ipynb` |
| Lab 9 | ML Types | `Lab-9-ML-types.ipynb` |
| Lab 10 | Regression and Classification | `Lab-10-Regression-and-classification.ipynb` |
| Lab 11 | Missing Data and Bias | `Lab-11-Missing-data-and-bias.ipynb` |
| Lab 12 | Association Rules and Clustering | `Lab-12-Association-rules-and-clustering.ipynb` |
| Lab 13 | Deep Learning | `Lab-13-Deep-learning.ipynb` |
| Lab 14 | CNN | `Lab-14-CNN.ipynb` |
| Lab 15 | Constraint Programming | `Lab-15-Constraint-programming.ipynb` |
| Lab 16 | Transfer Learning | `Lab-16-Transfer-learning.ipynb` |
| Lab 17 | Reinforcement Learning | `Lab-17-Reinforcement-learning.ipynb` |
